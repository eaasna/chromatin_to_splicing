...
# overlap between ATAC peaks and RNA QTLs
#outfile = "/gpfs/rocket/home/a72094/projects/chromatin_to_splicing/results/rsquared", r_str, "/cqn_featureCounts_rsq.txt"
...
#outfile = paste("/gpfs/rocket/home/a72094/projects/chromatin_to_splicing/results/ctcf/cqn_rsq", r_str, ".txt", sep="")
#ca_file = "/gpfs/rocket/home/a72094/projects/chromatin_to_splicing/tabix/cqn_permutations_100000_significant.sorted.txt.gz"
...
for (sub in c("upstream", "contained", "downstream", "featureCounts")){
  ...
  #eqtl_file = "/gpfs/rocket/home/a72094/projects/chromatin_to_splicing/CTCF/CTCF.permuted.significant.sorted.txt.gz"
  #outfile = paste("/gpfs/rocket/home/a72094/projects/chromatin_to_splicing/results/ctcf/cqn_", sub, "_rsq", r_str, ".txt", sep="")
  #ca_file = paste("/gpfs/rocket/home/a72094/projects/chromatin_to_splicing/results/rsquared", r_str, "/cqn_", sub, "_enriched.sorted.txt.gz", sep="")
  ...
  for (chr in chrs){
    ...
    while (start < len - 2e+06) {
      ...
      caQTL = scanTabixDataFrame(ca_file, gr, col_names = FALSE)
      ...
      if (lengths(eQTL[])[1]!=0 & lengths(eQTL[])[1]!=1 & lengths(caQTL[])[1]!=0 & lengths(caQTL[])[1]!=1){
        ...
        if (length(e_genotypes)!=0 & length(ca_genotypes)!=0){
          ...
          significant = as.matrix(which(rsq_matrix > r, arr.ind = T))
