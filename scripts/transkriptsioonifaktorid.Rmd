---
title: "ENCODE HP1 seondumissaidid"
output:
...
test_RNAtunnused = function(higher, lower, tabel){
  return(fisher.test(rbind(c(tabel[higher, "RNA_TF"], tabel[lower, "RNA_TF"]),c(tabel[higher, "RNA_no_TF"], tabel[lower, "RNA_no_TF"])), alternative="less")$p.value)
}
```
